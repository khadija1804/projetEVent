...
import 'package:event/services/payment_service/payment_service.dart';
      ...
      activeColor: AppColors.blue,
              ...
              Row(
                children: [
                  ...
                  Spacer(),
                  myText(
                    text: '${widget.eventDoc!.get('price')} TND',
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                    ),
              ...
              Row(
                children: [
                  ...
                  Spacer(),
                  myText(
                    text: '${int.parse(widget.eventDoc!.get('price'))} TND',
                    style: TextStyle(
                      fontSize: 16,
                      color: AppColors.blue,
                      fontWeight: FontWeight.w600,
  ...
  if (selectedRadio == 4) {
    FirebaseFirestore.instance
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("Booking Confirmed. Pay on Arrival.")));
    ...
    makePayment(context,
        amount: '${int.parse(widget.eventDoc!.get('price')) + 2}',
