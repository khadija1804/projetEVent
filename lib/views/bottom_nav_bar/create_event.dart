                ...
                Obx(() => isCreatingEvent.value
                  ...
                  child: elevatedButton(
                      ...
                      onpress: () async {
                        ...
                        String thumbnailUrl= await dataController.uploadThumbnailToCloudinary(media[i].thumbnail!);

                        String videoUrl = await dataController.uploadImageToCloudinary(media[i].video!);
                          ...
                          mediaUrls.add({
                            ...
                            'isImage': false
                             ...
                             String imageUrl = await dataController.uploadImageToCloudinary(media[i].image!);
                            mediaUrls.add({
                              'url': imageUrl,
                              'isImage': true
                            });
