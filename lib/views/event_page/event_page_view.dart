...
import 'package:event/utils/date_formatter.dart';
...
int likes = 0;
              ...
              Container(
                ...
                backgroundImage: NetworkImage(image),
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "${widget.eventData.get('price')} TND",
                          style: TextStyle(
                            color: Colors.black,
                            fontWeight: FontWeight.w600,
                            fontSize: 18,
  ...
  children: [
    ...
    Expanded(
      child: InkWell(
        onTap: widget.eventData.get('max_entries') > 0
            ? () {
                Get.to(() => Inviteguest());
              }
            : null, // Disable if no spots left
        child: Container(
          height: 50,
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(13),
            color: widget.eventData.get('max_entries') > 0
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: widget.eventData.get('max_entries') > 0
                ? Colors.white
                : Colors.grey.withOpacity(0.6), // Grey out when disabled
            boxShadow: widget.eventData.get('max_entries') > 0
                ? [
                    BoxShadow(
