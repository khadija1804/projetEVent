...
import 'package:event/views/profile/profile.dart';
import 'package:event/views/update_event/update_event.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          children: [
            ...
            if (joinedUsers.contains(FirebaseAuth.instance.currentUser!.uid))
              IconButton(
                icon: Icon(Icons.edit, color: AppColors.blue),
                onPressed: () {
                  Get.to(() => UpdateEventView(
                        eventData: eventData!.data() as Map<String, dynamic>,
